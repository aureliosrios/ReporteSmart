...
|---|---|---|---|
| `docs/tareador.html` | Tareador | Trabajador, categoría, personas, horas y WBS | `AC_MO` |
| `docs/almacenero.html` | Almacenero | Material, cantidad, PU, destino WBS | `AC_MAT` |
| `docs/administradora.html` | Administradora | Equipo, servicio, HM/unidades, PU y WBS | `AC_EQP` / `AC_SUB` |
| `docs/ing_campo.html` | Ing. de Campo | Partida, tramo, metrado y WBS | `EV_PRODUCCION` |
| `docs/dashboard_ro.html` | Residente / OT | PV, EV, AC, CPI, SPI, EAC y brechas | Consulta |
...
- `docs/data/base_datos_reportabilidad.json`
...
1. El usuario abre el portal correspondiente desde `docs/index.html`.
...
`docs/data/base_datos_reportabilidad.json` actualizado con registros normalizados.

## 6. Etapa 2: consolidación JSON y Excel local

### Script

`scripts/generar_reportabilidad_excel.mjs`
...
- `docs/index.html`
- `docs/tareador.html`
- `docs/almacenero.html`
- `docs/administradora.html`
- `docs/ing_campo.html`
- `docs/dashboard_ro.html`
- `docs/assets/app.js`
- `docs/assets/style.css`
- `docs/data/presupuesto_con_apu.json`
- `docs/data/reportabilidad_schema.json`
