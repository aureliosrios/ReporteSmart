...
window.RO_API_ENDPOINT = "https://script.google.com/macros/s/AKfycby2Zo7hs1-aqsUBcPtL4Wrjjn7e3OUxEOwocNvABEKhPwfoUOeHTpnLBBhgFSHc9-SkPg/exec";
```
...
```javascript
localStorage.setItem('ro_api_endpoint', 'https://script.google.com/macros/s/AKfycby2Zo7hs1-aqsUBcPtL4Wrjjn7e3OUxEOwocNvABEKhPwfoUOeHTpnLBBhgFSHc9-SkPg/exec');
```
